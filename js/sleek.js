...
function GameDetails( servername, serverurl, rp_Rockford_v1b, maxplayers, steamid, darkrp ) {
	setGamemode(darkrp);
	setMapname(rp_Rockford_v1b);
...
function setGamemode(darkrp) {
	$("#gamemode").html(darkrp);
}

function setMapname(rp_Rockford_v1b) {
	$("#map").html(rp_Rockford_v1b);
}
